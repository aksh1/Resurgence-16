...
function type(entry)
{
	...
	document.getElementById("event_selection").value=entry;
	{
		if(entry=="literary")
		{
			text="<ol><li onClick='list_hover(this)'>Debate</li><li onClick='list_hover(this)'>Quiz</li><li onClick='list_hover(this)'>Group Extempore</li><li onClick='list_hover(this)'>Poetry</li><li onClick='list_hover(this)'>Essay Writing</li><li onClick='list_hover(this)'>Creative Writing</li></ol>";	
		}
		else
		if(entry=="music")
		{
